...
<div class="content">
<div class="card" >
  <form method="post" action="functions/company_signup.php" class="form-group" enctype="multipart/form-data" style="padding: 5px">
  <nav class="nav nav-pills nav-fill" style="margin: 10px">
  <a class="nav-item nav-link " href="sign_up.php">Job Seeker</a>
...
<div class="container">
  ...
  <div style="background-color: white;flex:1;text-align: center;">
        ...
        <input type="text" name="company_name" class="form-control" placeholder="Company Name" required>
         <select type="text" name="company_type" class="form-control" required> 
              ...
              <option value="Hospital_and_Tourism">Hospital and Tourism</option>
               <option value="Legal">Legal</option>
                 <option value="Media_and_Journalism">Media and Journalism</option>
                  <option value="Other_Companies">Other Companies</option>
    </select>


 
    <textarea type="text" name="about" class="form-control"  placeholder="About" required></textarea>
     
    <input type="text" name="location" class="form-control" placeholder="City/Town" required>

    <input type="email" name="email" class="form-control"  placeholder="Email" required>
    <input type="number" name="phone_number" class="form-control"  placeholder="Telephone Number" required>
